        ...
        <div class="card flex-fill">
          ...
          >
            <template #table-row="slotProps">
              ...
              <span v-if="slotProps.column.field === 'sku' && slotProps.row.outward_entry_item">
                {{ slotProps.row.outward_entry_item[0].sku }}
              </span>
              <span v-if="slotProps.column.field === 'stone_name' && slotProps.row.outward_entry_item">
                {{ slotProps.row.outward_entry_item[0].stone_name }}
              </span>
